...
所有模型通过 OpenAI 兼容接口统一调用，仅需配置 API Key：
...
- Python 3.10+
- `openai` — LLM 调用（兼容 DeepSeek/Kimi/GLM/MiniMax）
...
原日报生成功能仍可通过 `python src/main.py` 使用，详见 `python src/main.py --help`。
